...
const dataFrame = function(object,keys,types) {
  ...
  keys.forEach(function(column,idx) {
    self.writeValue(object[column],types[idx]);
  });
  ...
  this.listPairs(attributes,[ "names","row.names","class" ] ,["string","int","string"]);
};
...
const writeValue = function(value,type) {
  var self = this;
  if (value && value.constructor && value.constructor.name.indexOf('Stream') >= 0) {
